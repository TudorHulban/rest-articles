...
type ComplexityRoot struct {
	...
	Mutation struct {
		UpdateArticleTitle func(childComplexity int, id int, title string) int
		UpdateArticleURL   func(childComplexity int, id int, url string) int
	}

	Query struct {
		GetArticle func(childComplexity int, id int) int
	}
}

type MutationResolver interface {
	UpdateArticleTitle(ctx context.Context, id int, title string) (int, error)
	UpdateArticleURL(ctx context.Context, id int, url string) (int, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.UpdateArticleTitle":
		...
		return e.complexity.Mutation.UpdateArticleTitle(childComplexity, args["id"].(int), args["title"].(string)), true

	case "Mutation.UpdateArticleURL":
		if e.complexity.Mutation.UpdateArticleURL == nil {
			break
		}

		args, err := ec.field_Mutation_UpdateArticleURL_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Mutation.UpdateArticleURL(childComplexity, args["id"].(int), args["url"].(string)), true
	...
	case "Query.GetArticle":
		...
		return e.complexity.Query.GetArticle(childComplexity, args["id"].(int)), true
...
var sources = []*ast.Source{
	{Name: "../schemas/article.graphql", Input: `type Article {
  id: Int!
  title: String!
  url: String!
}
...
type Mutation {
  UpdateArticleTitle(id: Int!, title:String!): Int!
  UpdateArticleURL(id: Int!, url:String!): Int!
}
...
func (ec *executionContext) field_Mutation_UpdateArticleURL_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 int
	if tmp, ok := rawArgs["id"]; ok {
...
func (ec *executionContext) _Article_url(ctx context.Context, field graphql.CollectedField, obj *models.Article) (ret graphql.Marshaler) {
...
func (ec *executionContext) _Mutation_UpdateArticleTitle(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateArticleTitle(rctx, fc.Args["id"].(int), fc.Args["title"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_UpdateArticleURL(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Mutation_UpdateArticleURL(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateArticleURL(rctx, fc.Args["id"].(int), fc.Args["url"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_Mutation_UpdateArticleURL(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Mutation",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Mutation_UpdateArticleURL_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return
	}
	return fc, nil
...
func (ec *executionContext) _Query_GetArticle(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().GetArticle(rctx, fc.Args["id"].(int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalOArticle2ᚖgithubᚗcomᚋTudorHulbanᚋrestᚑarticlesᚋinfraᚋgraphqlᚋgeneratedᚋmodelsᚐArticle(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "UpdateArticleURL":

			out.Values[i] = ec.OperationContext.RootResolverMiddleware(innerCtx, func(ctx context.Context) (res graphql.Marshaler) {
				return ec._Mutation_UpdateArticleURL(ctx, field)
			})
...
func (ec *executionContext) marshalOArticle2ᚖgithubᚗcomᚋTudorHulbanᚋrestᚑarticlesᚋinfraᚋgraphqlᚋgeneratedᚋmodelsᚐArticle(ctx context.Context, sel ast.SelectionSet, v *models.Article) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
